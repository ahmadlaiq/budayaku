...
class PenyelenggaraController extends Controller
{
    ...
    {
        return view('auth.penyelenggara-login');
    }
    ...
    public function Login(Request $request)
    {
        ...
        // Proses Login
        if (Auth::guard('penyelenggara')->attempt(['email' => $request->email, 'password' => $request->password]))
        {
            // Redirect ke halaman penyelenggara jika berhasil
            //dd(Auth::guard('penyelenggara'));
    ...
    {
        return Auth::guard('penyelenggara');
    }

    public function RegisterPage(){
        return view('auth.penyelenggara-register');
    }
