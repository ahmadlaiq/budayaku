      ...
      <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
        <div class="card card-primary">
          <div class="modal-header">
            <div>
                <h5 class="modal-title title" id="exampleModalLongTitle2">Login Penyelenggara</h5>
                <p class="font-size-14">Untuk kamu yang sudah terdaftar, silahkan masuk.</p>
            </div>
        </div>

          <div class="card-body">
            <form method="POST" action="{{ route('penyelenggara.login')}}" class="needs-validation" novalidate="">
              @csrf
                <div class="card-body">
                    @if(session('errors'))
        ...
        <div class="mt-3 text-muted text-center">
          Belum mempunyai akun? <a href="{{ route('penyelenggara.register') }}">Daftar</a>
        </div>
        <div class="mt-3 text-muted text-center">
          <a href="{{ route('peserta.login') }}">Login Sebagai Peserta</a>
        </div>
