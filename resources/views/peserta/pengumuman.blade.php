                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title font-size-30 text-white">Pengumuman Kompetisi</h2>
                        </div>
                ...
                render: function (meta, data, row) {
                    var div = `<div class="col-lg-12 template">
                        <div class="card-item card-item-list" style="margin-top:15px;">
                            <div class="card-img">
                                <a href="pemenang/kompetisi/` + row.id + `" class="d-block">
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="pemenang/kompetisi/` + row.id + `">` + row.judul_kompetisi + `</a>
                                </h3>
                                ...
                                <div class="col-sm-6 text-right"> 
                                        <a href="pemenang/kompetisi/` + row.id + `" class="btn-text">Lihat Pemenang</a>
