                                ...
                                <div class="dropdown">
                                    <a href="#" class="dropdown-toggle" id="userDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="font-size-14 font-weight-bold">{{ Auth::guard('peserta')->user()->nama_lengkap }}</span>
                                        </div>
                                    </a>
                                    <div class="dropdown-menu dropdown-reveal dropdown-menu-md dropdown-menu-right">
                                        ...
                                        <div class="list-group drop-reveal-list user-drop-reveal-list">
                                            <a href="{{ url('peserta.profile') }}" class="list-group-item list-group-item-action">
                                                <div class="msg-body">
                                            ...
                                            <a href="{{ route('peserta.pengaturan') }}" class="list-group-item list-group-item-action">
                                                <div class="msg-body">
                                                    <div class="msg-content">
